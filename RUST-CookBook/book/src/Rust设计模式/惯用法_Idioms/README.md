...
Rust Design Patterns中的Idioms按相关知识点归档，本页作为统一索引。

| Idiom | 实际归属 | 原文 |
| --- | --- | --- |
| Use borrowed types for arguments | [使用借用类型作为函数参数](../../理解所有权/使用借用类型作为函数参数/) | [原文](https://rust-unofficial.github.io/patterns/idioms/coercion-arguments.html) |
| `mem::{take(_), replace(_)}` | [使用mem::take和mem::replace转移可变引用中的所有权](../../理解所有权/使用mem-take和replace转移可变引用中的所有权/) | [原文](https://rust-unofficial.github.io/patterns/idioms/mem-replace.html) |
| Temporary mutability | [使用临时可变性明确修改范围](../../常见编程概念/使用临时可变性明确修改范围/) | [原文](https://rust-unofficial.github.io/patterns/idioms/temporary-mutability.html) |
| Constructor | [Constructor构造函数惯例](../../使用struct组织关联数据/Constructor构造函数惯例/) | [原文](https://rust-unofficial.github.io/patterns/idioms/ctor.html) |
...
| Iterating over an Option | [对Option进行迭代](../../函数式语言特性_Iterator与闭包/对Option进行迭代/) | [原文](https://rust-unofficial.github.io/patterns/idioms/option-iter.html) |
...
| Easy doc initialization | [简化rustdoc示例初始化](../../扩展知识体系/简化rustdoc示例初始化/) | [原文](https://rust-unofficial.github.io/patterns/idioms/rustdoc-init.html) |
